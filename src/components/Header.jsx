...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto px-5 flex items-center justify-between h-32 lg:h-[140px]">
        {/* Brand */}
        <div className="flex items-center gap-2.5 mr-auto">
          <div 
            className="h-[110px] lg:h-[130px] w-auto overflow-hidden rounded-lg"
            aria-hidden="true"
          >
            <img 
              src="logo.svg" 
